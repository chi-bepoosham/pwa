...
import { Drawer, DrawerBody, DrawerContent, DrawerFooter, DrawerHeader, addToast } from "@heroui/react"
    ...
    return (
        ...
        >
            <DrawerContent>
                ...
                <DrawerBody
                    className="flex flex-col justify-start h-full min-w-[500px] max-w-full items-center gap-10 overflow-y-auto"
                >
                ...
                <DrawerFooter
                    className="sticky bottom-0 z-10 w-full bg-white justify-center"
                >
                    <MinorButton
                        variant="solid"
                        color="primary"
