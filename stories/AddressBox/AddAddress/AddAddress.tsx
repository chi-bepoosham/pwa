...
export const AddAddress = (props: AddAddressProps) => {
  ...
  return (
    <div className="w-full h-full max-w-lg mx-auto flex flex-col gap-3">
      ...
      <Card
        isPressable
        className="w-full shadow-none border-2 border-primary-100"
      ...
      >
        <DrawerContent>
          <DrawerHeader className="flex flex-row gap-4 justify-center items-center sticky top-0 z-10 pb-5">
            <i className="text-secondary-200 rotate-180">
              <CometStarVector />
            </i>
            <span className="truncate">آدرس و کــد پستـــی</span>
          ...
          <DrawerBody className="flex flex-col items-start gap-4  w-[640px] max-w-full" dir="rtl">
            <div className="flex flex-col gap-7 justify-center items-center w-full">
              ...
              <MinorInput type="description" placeholder="خیابان، کوچه، جزئیات آدرس" />
            </div>
            <div className="flex flex-row justify-center items-center gap-3 w-full">
              <MinorInput type="plate" placeholder="پلاک" />
              <MinorInput type="unit" placeholder="واحد" />
            </div>
            <div className="w-full">
              <MinorInput type="discount" label="کدپستی گیرنده" placeholder="کد پستی" />
            </div>
