...
export const ClosetSlider = (props: ClosetSliderProps) => {
    ...
    return (
        <div className="flex flex-col gap-12 justify-center items-center select-none">
            <div
                className={clsx("relative w-fit h-fit flex flex-col justify-start items-center border-2 border-secondary rounded-xl bg-white select-none", isSubImage ? "flex justify-center items-center p-0" : "p-2")}>
                {isSubImage && (
                    <div
