    ...
    return (
        <div className="flex items-center gap-4 p-4 rounded-2xl group/pitem">
            <div
                ...
                />
                <span
                    className="absolute flex justify-center items-center bottom-2 left-2 border-2 border-white bg-secondary-100 w-6 aspect-square backdrop-blur text-white rounded-lg"
                >
          {count}
        </span>
            </div>
