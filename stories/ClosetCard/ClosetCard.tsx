...
export const ClosetCard = (props: ClosetCardProps) => {
    const { variant, imageUrl, matchPercentage, onClick, link, isSliderActive, onDelete } = props;
    ...
    return (
        ...
        <div 
            onClick={onClick}
            className={clsx(
                'min:w-60 mx-auto rounded-[18px] overflow-hidden cursor-pointer p-1.5',
                'flex flex-col',
                'shrink-0',
                'select-none',
                'relative',
...
// Example usage of ClosetCard component
// const ExampleUsage = () => {
