...
export const Social = (props: SocialProps) => {
    ...
    return (
        <div className="flex flex-row-reverse gap-6 justify-center">
            <Button
                variant="bordered"
                className="w-40 h-40 flex flex-col items-center justify-center border-2 border-primary rounded-2xl bg-primary-50 focus:bg-primary focus:text-white focus:transition focus:duration-500"
            >
                <i className="mb-2">
