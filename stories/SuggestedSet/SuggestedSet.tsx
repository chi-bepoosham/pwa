...
export const SuggestedSet = (props: SuggestedSetProps) => {
    ...
    return (
        ...
        >
            ...
            <div
                className="hidden sm:flex cursor-pointer absolute z-10 top-5 -right-32 bg-secondary-50 backdrop-blur rounded-t-lg rounded-b-2xl w-fit h-fit flex-row justify-center items-center p-2 gap-2"
            >
